...
4. **말투/용어**: `lib/destinyGen.ts`의 STYLE_GUIDE를 따른다 — **한자·사주 전문용어(오행/일간/천간/지지 등) 노출 금지**, 다정하고 쉬운 한국어. **단정적 예언 금지**, "오락·자기이해 목적" 고지 유지. (예외: 작명 상품은 엔진 데이터(인명용 한자)에 한해 한자 표시 허용, AI 문장엔 금지.)
