        ...
        {showNotificationPrompt && (
          ...
          >
            <div className="mx-auto max-w-md bg-white border border-[#FF8AA1]/30 shadow-2xl rounded-2xl p-4 flex items-center justify-between gap-3 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#FF8AA1] to-coral"></div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-ink">알림을 켜고 소식을 받으세요</p>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="bg-coral text-white text-xs font-semibold py-2 px-4 rounded-full active:scale-95 transition-transform"
                >
                  알림 켜기
                </button>
                <button
        ...
        {showBanner && (
          ...
          >
            <div className="mx-auto max-w-md bg-white border border-[#FF8AA1]/30 shadow-2xl rounded-2xl p-4 flex items-center justify-between gap-3 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-cream flex items-center justify-center flex-shrink-0">
                  <Image src="/icons/icon-192.png" alt="콩닥" width={28} height={28} className="w-7 h-7 rounded-lg object-contain" />
                </div>
                <div>
                  <p className="text-sm font-bold text-ink">콩닥 앱 설치하고</p>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
            ...
            >
              <div className="text-center mb-6">
                <div className="w-16 h-16 mx-auto bg-cream rounded-2xl flex items-center justify-center mb-4">
                  <Image src="/icons/icon-192.png" alt="콩닥" width={40} height={40} className="w-10 h-10 rounded-xl object-contain" />
                </div>
                <h3 className="text-lg font-bold text-ink mb-2">iOS 홈 화면에 추가하기</h3>
              ...
              <button
                ...
                className="w-full py-3 bg-coral text-white rounded-xl font-bold active:scale-95 transition-transform"
              >
                확인
              </button>
            </motion.div>
