...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 w-full border-t border-ink/8 bg-background/80 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="mt-6 pt-4 border-t border-ink/8 flex flex-col items-center justify-center gap-2">
          <div className="flex items-center gap-2">
      ...
      <div className="w-full border-t border-ink/8 bg-ink/[0.02] px-4 sm:px-6 py-4">
