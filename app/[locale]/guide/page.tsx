...
const faqs = [
  ...
  },
  {
    ...
    a: (
      <>
        네. 비회원으로 입력한 생년월일·태어난 시간은 그대로 저장하지 않고 <strong className="text-ink font-bold">되돌릴 수 없는 해시로만</strong> 보관해요. 회원이 &lsquo;내 사주 정보&rsquo;를 저장하면 매일 운세를 위해 보관하고, 탈퇴하면 지워져요. 자세한 내용은 개인정보처리방침에서 확인하세요.
      </>
    ),
  },
  {
...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "비회원으로 입력한 생년월일·태어난 시간은 원본으로 저장하지 않고 되돌릴 수 없는 해시로만 보관합니다. 회원이 내 사주 정보를 저장하면 매일 운세를 위해 보관하며 탈퇴 시 파기합니다. 자세한 내용은 개인정보처리방침에서 확인할 수 있습니다.",
      },
    },
    {
      "@type": "Question",
