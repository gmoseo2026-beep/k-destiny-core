...
async def catch_attempt2_force():
    async with async_playwright() as pw:
        ...
        print("Forcing browser to fetch the video again to trigger 302...")
        # Create a new video element and append it to trigger fetch
        ...
        await browser.close()
asyncio.run(catch_attempt2_force())
