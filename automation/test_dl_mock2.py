...
async def test_dl():
    async with async_playwright() as pw:
        ...
        # Override showSaveFilePicker to create a regular download link
        await page.evaluate('''
            window.showSaveFilePicker = async (options) => {
                console.log("showSaveFilePicker called!");
                throw new TypeError("window.showSaveFilePicker is not a function");
            };
        ''')
